...
author: "Kayoung Goffe & Adam Ivison"
date: "10/03/2022"
output:
...
We were recommended to test using three accessibility tools; WAVE, Lighthouse and Axe Devtools. These are all freely available and easily installed through google extension. The idea was to remove any serious or critical errors from these tests. Some of the errors were easy to fix. For example, for accessibility reasons, page language was required to declare. To fix that issue, we just needed to add one html tag `lang = "en"`.
